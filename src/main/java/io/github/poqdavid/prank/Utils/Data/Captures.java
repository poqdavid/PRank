...
public class Captures implements Serializable {
    ...
    private final static long serialVersionUID = 2089856043536453521L;
     ...
     * @param multiplier
     */
    public Captures(Integer normal, Integer shiny, Integer legendary, Integer ultrabeast, Integer multiplier) {
        super();
        this.normal = normal;
        this.shiny = shiny;
    ...
    public Captures withMultiplier(Integer multiplier) {
        this.multiplier = multiplier;
        return this;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("normal", normal).append("shiny", shiny).append("legendary", legendary).append("ultrabeast", ultrabeast).append("multiplier", multiplier).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(legendary).append(normal).append(ultrabeast).append(shiny).append(multiplier).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(legendary, rhs.legendary).append(normal, rhs.normal).append(ultrabeast, rhs.ultrabeast).append(shiny, rhs.shiny).append(multiplier, rhs.multiplier).isEquals();
    }
