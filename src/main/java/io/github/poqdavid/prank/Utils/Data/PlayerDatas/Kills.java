...
public class Kills implements Serializable {
    ...
    private final static long serialVersionUID = 4090974921468801743L;
     ...
     * @param shiny
     */
    public Kills(Integer normal, Integer shiny, Integer legendary, Integer boss, Integer ultrabeast) {
        super();
        this.normal = normal;
        this.shiny = shiny;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("normal", normal).append("shiny", shiny).append("legendary", legendary).append("boss", boss).append("ultrabeast", ultrabeast).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(legendary).append(boss).append(normal).append(ultrabeast).append(shiny).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(legendary, rhs.legendary).append(boss, rhs.boss).append(normal, rhs.normal).append(ultrabeast, rhs.ultrabeast).append(shiny, rhs.shiny).isEquals();
    }
